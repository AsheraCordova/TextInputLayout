...
return layoutParams.weight;			}
	...
	public class TextInputLayoutExt extends r.android.widget.LinearLayout implements ILifeCycleDecorator, com.ashera.widget.IMaxDimension{
		...
		protected void onLayout(boolean changed, int l, int t, int r, int b) {
	        ...
	        overlays = ViewImpl.drawOverlay(TextInputLayoutImpl.this, overlays);
    	...
    	public r.android.view.View inflateView(java.lang.String layout) {
    		...
    		IWidget widget = template.loadLazyWidgets(TextInputLayoutImpl.this);
		...
		public void setMyAttribute(String name, Object value) {
			...
			TextInputLayoutImpl.this.setAttribute(name, value, !(value instanceof String));
		}
        @Override
...
public java.util.Map<String, Object> getOnLongClickEventObj(View v) {
	...
	private void syncBackground() {
		org.eclipse.swt.widgets.Control c = (org.eclipse.swt.widgets.Control)editTextHolder.get(0).asNativeWidget();
		org.eclipse.swt.widgets.Control c1 = (org.eclipse.swt.widgets.Control)innerLayout.asNativeWidget();
		c.setBackground(c1.getBackground());
	}
