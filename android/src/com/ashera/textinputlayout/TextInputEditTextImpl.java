...
return null;				}
	...
	private void removeaddTextChangedListenerIfNeeded(String action) {
		if (isInitialised()) {
			List<IListener> listeners = (List<IListener>)getFieldValueUsingReflection(textInputEditText, "mListeners");
			if (listeners != null) {
...
public java.util.Map<String, Object> getOnEditorActionEventObj(TextView v,int actionId,KeyEvent event) {
	...
	public void setId(String id){
		if (id != null && !id.equals("")){
			super.setId(id);
			textInputEditText.setId(IdGenerator.getId(id));
		}
	}
...
public TextInputEditTextCommandBuilder setTextSize(String value) {
	...
	attrs.put("value", value);
return this;}
public TextInputEditTextCommandBuilder setDrawableLeft(String value) {
...
public TextInputEditTextCommandBuilder setDrawableStart(String value) {
	...
	attrs.put("value", value);
return this;}
public TextInputEditTextCommandBuilder setDrawableRight(String value) {
