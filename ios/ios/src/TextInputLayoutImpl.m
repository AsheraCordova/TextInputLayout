...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[103].selector = @selector(syncBackground);
  methods[104].selector = @selector(isPaddingFixNeeded);
