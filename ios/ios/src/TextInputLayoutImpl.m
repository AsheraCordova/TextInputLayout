...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[4].selector = @selector(initWithASTextInputLayoutImpl:);
  ...
  static const J2ObjcClassInfo _ASTextInputLayoutImpl_TextInputLayoutExt = { "TextInputLayoutExt", "com.ashera.textinputlayout", ptrTable, methods, fields, 7, 0x1, 24, 6, 3, -1, -1, -1, -1 };
